...
async function runTests() {
  console.log('🎯 **CANCEL WIN TRANSACTION TEST**');
  console.log('==================================');
  ...
  // Test 2: Try to cancel a win transaction
  console.log('\n📊 **STEP 2: Test Cancel Win Operation**');
  const transactionToCancel = '2234931'; // Win transaction of $0.39
  ...
  if (cancelBalance !== null) {
    ...
    console.log(`💰 Expected: $${(initialBalance - 0.39).toFixed(2)} (deduct $0.39 for win cancellation)`);
    ...
    if (finalBalance !== null) {
      ...
      const expectedBalance = initialBalance - 0.39;
      if (Math.abs(finalBalance - expectedBalance) < 0.01) {
        console.log('✅ BALANCE CALCULATION: PASSED');
        console.log('✅ Win cancellation correctly deducted the amount');
      } else {
