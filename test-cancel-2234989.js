...
async function runTests() {
  console.log('🎯 **CANCEL TRANSACTION 2234989 TEST**');
  console.log('======================================');
  ...
  // Test 2: Try to cancel transaction 2234989
  console.log('\n📊 **STEP 2: Test Cancel Operation**');
  const transactionToCancel = '2234989'; // The transaction from the user's message
