...
const admin_bet_analytics_controller_1 = require("../api/admin/admin.bet-analytics.controller");
...
router.get("/bets", authenticate_1.authenticate, (0, authorize_1.authorize)(["Admin"]), async (req, res) => {
    ...
    `;
        ...
        // Format the response
        const enrichedBets = result.rows.map((bet) => ({
            bet_id: bet.bet_id,
            user_id: bet.user_id,
 ...
 *         description: Unauthorized
 */
router.get("/bets/statistics", authenticate_1.authenticate, (0, authorize_1.authorize)(["Admin"]), admin_bet_analytics_controller_1.getBetStatistics);
/**
 * @swagger
 ...
 *         description: Unauthorized
 */
router.get("/bets/analytics", authenticate_1.authenticate, (0, authorize_1.authorize)(["Admin"]), admin_bet_analytics_controller_1.getBetAnalytics);
/**
 * @swagger
 ...
 *         description: Unauthorized
 */
router.get("/bets/game-performance", authenticate_1.authenticate, (0, authorize_1.authorize)(["Admin"]), admin_bet_analytics_controller_1.getGamePerformance);
/**
 * @swagger
 ...
 *         description: Unauthorized
 */
router.get("/bets/results-distribution", authenticate_1.authenticate, (0, authorize_1.authorize)(["Admin"]), admin_bet_analytics_controller_1.getResultsDistribution);
/**
 * @swagger
 ...
 *         description: Unauthorized
 */
router.get("/bets/provider-performance", authenticate_1.authenticate, (0, authorize_1.authorize)(["Admin"]), admin_bet_analytics_controller_1.getProviderPerformance);
/**
 * @swagger
 ...
 *         description: Unauthorized
 */
router.get("/bets/player-analytics", authenticate_1.authenticate, (0, authorize_1.authorize)(["Admin"]), admin_bet_analytics_controller_1.getPlayerAnalytics);
/**
 * @swagger
 ...
 *         description: Unauthorized
 */
router.get("/bets/time-analytics", authenticate_1.authenticate, (0, authorize_1.authorize)(["Admin"]), admin_bet_analytics_controller_1.getTimeAnalytics);
/**
 * @swagger
