...
const promotion_controller_1 = require("../api/promotion/promotion.controller");
const authenticate_1 = require("../middlewares/authenticate");
const validate_1 = require("../middlewares/validate");
const promotion_schema_1 = require("../api/promotion/promotion.schema");
 ...
 */
router.get("/", authenticate_1.authenticate, promotion_controller_1.getAvailablePromotions);
/**
 * @openapi
 ...
 *         description: Internal server error
 */
router.post("/claim", authenticate_1.authenticate, (0, validate_1.validate)({ body: promotion_schema_1.ClaimPromotionSchema }), promotion_controller_1.claimPromotion);
/**
 * @openapi
 * /api/promotions/my:
 *   get:
 ...
 *         description: Internal server error
 */
router.get("/my", authenticate_1.authenticate, promotion_controller_1.getUserPromotions);
/**
 * @openapi
 ...
 *         description: Internal server error
 */
router.get("/daily-spin", authenticate_1.authenticate, promotion_controller_1.getDailySpin);
/**
 * @openapi
 * /api/promotions/daily-spin:
 *   post:
 ...
 *         description: Internal server error
 */
router.post("/daily-spin", authenticate_1.authenticate, promotion_controller_1.performDailySpin);
/**
 * @openapi
 ...
 *         description: Internal server error
 */
router.get("/wagering-progress", authenticate_1.authenticate, promotion_controller_1.getWageringProgress);
/**
 * @openapi
 ...
 *         description: Internal server error
 */
router.get("/bonus-summary", authenticate_1.authenticate, promotion_controller_1.getBonusBalanceSummary);
/**
 * @openapi
 ...
 *         description: Internal server error
 */
router.post("/transfer-bonus", authenticate_1.authenticate, promotion_controller_1.transferBonusToMain);
/**
 * @openapi
 ...
 *         description: Internal server error
 */
router.get("/:promotion_id/eligibility", authenticate_1.authenticate, promotion_controller_1.checkPromotionEligibility);
/**
 * @openapi
 ...
 *         description: Internal server error
 */
router.post("/validate-promo-code", promotion_controller_1.validatePromoCode);
/**
 * @openapi
 ...
 *         description: Internal server error
 */
router.post("/apply-promo-code", authenticate_1.authenticate, promotion_controller_1.applyPromoCode);
/**
 * @openapi
 ...
 *         description: Internal server error
 */
router.post("/auto-apply", authenticate_1.authenticate, promotion_controller_1.autoApplyBestPromotion);
