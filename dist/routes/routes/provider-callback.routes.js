...
const provider_callback_service_1 = require("../services/provider/provider-callback.service");
...
const handleProviderCallback = async (req, res) => {
    ...
    try {
        ...
        if (req.method === 'GET') {
            ...
            const response = await provider_callback_service_1.ProviderCallbackService.handlePing();
        ...
        // Handle the request
        const response = await provider_callback_service_1.ProviderCallbackService.handleRequest(req.body, authHeader);
