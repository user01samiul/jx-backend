...
exports.getAuditLogsSchema = exports.cloneBonusPlanSchema = exports.bulkForfeitBonusesSchema = exports.bulkGrantBonusesSchema = exports.setCategoryContributionSchema = exports.bulkSetGameContributionSchema = exports.setGameContributionSchema = exports.forfeitBonusSchema = exports.getUserBonusesSchema = exports.applyBonusCodeSchema = exports.getBonusPlansSchema = exports.grantManualBonusSchema = exports.updateBonusPlanSchema = exports.createBonusPlanSchema = void 0;
...
exports.setGameContributionSchema = zod_1.z.object({
    game_id: zod_1.z.coerce.number().int().positive(),
    contribution_percentage: zod_1.z.coerce.number().min(0).max(100),
...
// =====================================================
exports.setCategoryContributionSchema = zod_1.z.object({
...
// =====================================================
exports.bulkGrantBonusesSchema = zod_1.z.object({
    player_ids: zod_1.z.array(zod_1.z.number().int().positive()).min(1).max(100),
    bonus_plan_id: zod_1.z.number().int().positive(),
    custom_amount: zod_1.z.number().positive().optional().nullable(),
    notes: zod_1.z.string().min(5).max(500)
});
exports.bulkForfeitBonusesSchema = zod_1.z.object({
    bonus_instance_ids: zod_1.z.array(zod_1.z.number().int().positive()).min(1).max(100),
    reason: zod_1.z.string().min(5).max(500)
});
// =====================================================
// BONUS PLAN ADVANCED SCHEMAS
// =====================================================
exports.cloneBonusPlanSchema = zod_1.z.object({
    name: zod_1.z.string().min(3).max(255).optional(),
    start_date: zod_1.z.coerce.date().optional(),
    end_date: zod_1.z.coerce.date().optional(),
    bonus_code: zod_1.z.string().max(50).optional().nullable(),
...
exports.getAuditLogsSchema = zod_1.z.object({
    admin_user_id: zod_1.z.coerce.number().int().optional(),
    player_id: zod_1.z.coerce.number().int().optional(),
    action_type: zod_1.z.string().optional(),
    bonus_plan_id: zod_1.z.coerce.number().int().optional(),
