...
exports.ISoftBetProxyController = void 0;
class ISoftBetProxyController {
    /**
     ...
     */
    static async generateXML(req, res) {
        try {
     ...
     */
    static generateGameConfigXML(gameCode, sessionId) {
...
<reels>
  ...
  <reel id="6">${generateReelStrip(6)}</reel>
     ...
     */
    static generatePaytableConfigXML(gameCode, sessionId) {
        return `<?xml version="1.0" encoding="UTF-8"?>
<paytable>
...
exports.ISoftBetProxyController = ISoftBetProxyController;
