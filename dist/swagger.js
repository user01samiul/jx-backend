...
const swaggerAuth_middleware_1 = require("./middlewares/swaggerAuth.middleware");
...
const setupSwagger = (app) => {
    ...
    app.get("/api-docs.json", swaggerAuth_middleware_1.swaggerAuthMiddleware, (_req, res) => {
    ...
    app.use("/docs", swaggerAuth_middleware_1.swaggerAuthMiddleware, swagger_ui_express_1.default.serve, swagger_ui_express_1.default.setup(swaggerSpec, {
        explorer: true,
        swaggerOptions: {
