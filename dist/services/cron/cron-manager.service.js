...
const profit_cron_service_1 = require("../profit/profit-cron.service");
// =====================================================
...
class CronManagerService {
    ...
    static startAllCronJobs() {
        ...
        const autoAdjustInterval = setInterval(() => {
            ...
            profit_cron_service_1.profitCronJobs.autoAdjustRtp().catch(error => {
        ...
        const dailySummaryInterval = setInterval(() => {
            ...
            profit_cron_service_1.profitCronJobs.dailySummary().catch(error => {
        ...
        const weeklyAnalyticsInterval = setInterval(() => {
            ...
            profit_cron_service_1.profitCronJobs.weeklyAnalytics().catch(error => {
        ...
        const monthlyCleanupInterval = setInterval(() => {
            ...
            if (now.getDate() === 1) { // Only run on first day of month
                ...
                profit_cron_service_1.profitCronJobs.monthlyCleanup().catch(error => {
    ...
    static async triggerAutoAdjustment() {
        ...
        try {
            const result = await profit_cron_service_1.profitCronJobs.autoAdjustRtp();
    ...
    static async triggerDailySummary() {
        ...
        try {
            const result = await profit_cron_service_1.profitCronJobs.dailySummary();
