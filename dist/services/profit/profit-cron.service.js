...
exports.profitCronJobs = exports.ProfitCronService = void 0;
const profit_control_service_1 = require("./profit-control.service");
// =====================================================
// PROFIT CONTROL CRON SERVICE
// =====================================================
class ProfitCronService {
    ...
    static async autoAdjustRtpCron() {
        try {
            ...
            const adjustment = await profit_control_service_1.ProfitControlService.autoAdjustEffectiveRtp();
            ...
            const performance = await profit_control_service_1.ProfitControlService.calculateProfitPerformance();
    ...
    static async weeklyProfitAnalyticsCron() {
        try {
            ...
            const analytics = await profit_control_service_1.ProfitControlService.getProfitAnalytics({
            ...
            if (analytics.byGame.length > 0) {
                ...
                analytics.byGame.slice(0, 5).forEach((game, index) => {
...
exports.ProfitCronService = ProfitCronService;
// Export cron functions for external scheduling
exports.profitCronJobs = {
