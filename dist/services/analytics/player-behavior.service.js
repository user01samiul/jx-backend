...
exports.PlayerBehaviorService = void 0;
...
class PlayerBehaviorService {
    ...
    static async startSession(session) {
        const sessionId = session.session_id || (0, uuid_1.v4)();
        const query = `
     ...
     */
    static async endSession(sessionId, metrics) {
        const query = `
     ...
     */
    static async getPlayerBehavior(userId, days = 30) {
        const query = `
     ...
     */
    static async saveBehaviorScores(userId, scores) {
        const query = `
     ...
     */
    static async getTopPlayersByEngagement(limit = 100) {
        const query = `
      SELECT
        u.id,
        u.username,
     ...
     */
    static async getSessionHeatmap(days = 30) {
        const query = `
      SELECT
