...
const TRANSACTIONS_TO_CANCEL = [
    '2236510', // Third bet (most recent) - should return $0.12 net loss
    '2236501', // Second bet - should return $0.08 net loss  
    '2236492'  // First bet - should return $0.16 net loss
];

// Expected net losses based on the transaction data:
// Bet 1: $0.20 bet - $0.04 win = $0.16 net loss
// Bet 2: $0.20 bet - $0.12 win = $0.08 net loss
// Bet 3: $0.20 bet - $0.08 win = $0.12 net loss
// Total expected refund: $0.16 + $0.08 + $0.12 = $0.36
...
async function testCancelNetLoss() {
    console.log('🔄 Cancel Net Loss Test');
    console.log('=' .repeat(50));
    console.log('📋 Test Flow:');
    console.log('1. Check initial category balance ($50.00)');
    console.log('2. Cancel bet 3 (should return $0.12 net loss)');
    console.log('3. Cancel bet 2 (should return $0.08 net loss)');
    console.log('4. Cancel bet 1 (should return $0.16 net loss)');
    console.log('5. Verify final balance is $50.36');
    console.log('=' .repeat(50));
    ...
    try {
        ...
        // Step 2: Cancel bet 3 (most recent) - should return $0.12
        console.log('\n🔄 Step 2: Cancelling bet 3 (should return $0.12 net loss)...');
        ...
        const refund3 = currentBalance - initialBalance;
        totalRefunded += refund3;
        console.log(`📊 Category balance after cancel 3: $${currentBalance} (refunded: $${refund3.toFixed(2)})`);
        
        // Step 3: Cancel bet 2 - should return $0.08
        console.log('\n🔄 Step 3: Cancelling bet 2 (should return $0.08 net loss)...');
        ...
        const refund2 = currentBalance - parseBalance(balanceAfter3);
        totalRefunded += refund2;
        console.log(`📊 Category balance after cancel 2: $${currentBalance} (refunded: $${refund2.toFixed(2)})`);
        
        // Step 4: Cancel bet 1 - should return $0.16
        console.log('\n🔄 Step 4: Cancelling bet 1 (should return $0.16 net loss)...');
        ...
        const expectedFinalBalance = 50.36; // $50.00 + $0.36 total refund
        ...
        if (isCorrect) {
            ...
            console.log(`📊 Total refunded: $${totalRefunded.toFixed(2)} (expected: $0.36)`);
        } else {
        ...
        console.log(`After Cancel 3: $${parseBalance(balanceAfter3)} (refunded: $${refund3.toFixed(2)})`);
        console.log(`After Cancel 2: $${parseBalance(balanceAfter2)} (refunded: $${refund2.toFixed(2)})`);
        ...
        console.log('\n🎉 Cancel Net Loss Test completed!');
        console.log('=' .repeat(50));
