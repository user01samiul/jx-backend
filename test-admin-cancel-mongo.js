...
async function testAdminCancelMongo() {
  try {
    console.log('=== Testing Admin Bet Cancellation MongoDB Transaction Creation ===\n');
    ...
    const cancelRequest = {
      ...
      admin_note: 'Testing MongoDB transaction creation',
      notify_user: false,
