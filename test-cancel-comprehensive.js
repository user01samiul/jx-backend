...
async function runTests() {
  console.log('🎯 **COMPREHENSIVE CANCEL TEST**');
  console.log('================================');
  ...
  // Test 2: Try to cancel a recent bet transaction
  console.log('\n📊 **STEP 2: Test Cancel Operation**');
  const transactionToCancel = '2234930'; // Recent bet transaction
  ...
  if (cancelBalance !== null) {
    ...
    if (finalBalance !== null) {
      ...
      if (finalBalance < 100) {
        console.log('✅ BALANCE RANGE: PASSED');
        console.log('✅ Balance is in reasonable range (under $100)');
      } else {
        console.log('❌ BALANCE RANGE: FAILED');
        console.log('❌ Balance is too high, indicating an error');
      }
    }
  }
