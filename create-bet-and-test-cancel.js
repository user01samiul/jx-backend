...
// Create Bet and Test Cancel
async function createBetAndTestCancel() {
  try {
    console.log('🧪 **CREATE BET AND TEST CANCEL**');
    console.log('==================================');
    
    // Step 1: Create a bet transaction for user 48
    console.log('\n🎯 **STEP 1: CREATING BET TRANSACTION**');
    ...
    console.error('❌ Error in create bet and test cancel:', error.response?.data || error.message);
  }
}

// Run the test
createBetAndTestCancel(); 