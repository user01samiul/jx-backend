...
export class HealthMonitorService {
  ...
  private static criticalErrors: any[] = [];
   ...
   */
  static updateCircuitBreakerStatus(status: any) {
   ...
   */
  static trackCriticalError(error: any, context: any = {}) {
    const errorInfo = {
   ...
   */
  static getHealthStatus(): SystemStatus {
   ...
   */
  private static performHealthChecks() {
   ...
   */
  private static checkDatabaseHealth(): boolean {
   ...
   * Log health status
   */
  private static logHealthStatus() {
