 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get('/my-modules', AdminModulesController.getMyModules);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get('/roles', authorize([Roles.ADMIN]), AdminModulesController.getAvailableRoles);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get('/by-role/:roleId', authorize([Roles.ADMIN]), AdminModulesController.getModulesByRole);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get('/all', authorize([Roles.ADMIN]), AdminModulesController.getAllModules);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.post('/', authorize([Roles.ADMIN]), AdminModulesController.createModule);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.put('/:id', authorize([Roles.ADMIN]), AdminModulesController.updateModule);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.delete('/:id', authorize([Roles.ADMIN]), AdminModulesController.deleteModule);
