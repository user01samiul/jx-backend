...
import { getMaintenance, setMaintenance, toggleMaintenance } from "../api/settings/settings.controller";
const router = Router();
 ...
 *                   example: true
 */
router.get("/settings/maintenance", getMaintenance);
router.post("/settings/maintenance", setMaintenance);
router.post("/settings/maintenance/toggle", toggleMaintenance);
