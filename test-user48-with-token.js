...
// Use existing token for user 48 and game 44
...
async function testUser48WithToken() {
  try {
    console.log('🧪 Testing user 48 (player50) with existing token on disabled game...');
    ...
    // Step 1: Check balance using existing token
    console.log('\n📊 Step 1: Checking balance with existing token...');
    ...
    // Step 2: Try to place a bet on disabled game (should fail)
    console.log('\n📤 Step 2: Trying to place bet on disabled game (should fail)...');
    ...
    // Step 3: Try to cancel the transaction (should also fail)
    console.log('\n📤 Step 3: Trying to cancel transaction on disabled game...');
